...
const steps = [
    {
        number: "01",
        title: "Discovery",
        description: "Understanding your vision through rapid AI-assisted research, competitive analysis, and structured interviews.",
        icon: Zap,
        color: "#FFC107",
    },
    {
        number: "02",
        title: "Design",
        description: "Rapid prototyping in Figma with AI-generated design explorations, going from concept to high-fidelity in days.",
        icon: Palette,
        color: "#7B61FF",
    },
    {
        number: "03",
        title: "Build",
        description: "AI-accelerated development with Cursor, Gemini & modern frameworks. Production-ready code at startup speed.",
        icon: Code2,
        color: "#06B6D4",
    },
    {
